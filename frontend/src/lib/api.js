...
export const api = {
  ...
  community: {
    ...
    createPost: (body, kind, communityId) => apiRequest('/community/posts', { method: 'POST', body: { body, kind, community_id: communityId || null } }),
    ...
    react: (postId) => apiRequest(`/community/posts/${postId}/reaction`, { method: 'PUT' }),
